...
abstract class SubscriptionView
  ...
  factory SubscriptionView.fromJson(Map<String, dynamic> jsonSerialization) {
    return SubscriptionView(
      ...
      currentPeriodStart: _isc.DateTimeJsonExtension.fromJson(
        jsonSerialization['currentPeriodStart'],
      ),
      currentPeriodEnd: _isc.DateTimeJsonExtension.fromJson(
      ...
      cancelAtPeriodEnd: _isc.BoolJsonExtension.fromJson(
