...
import 'package:gewerber_backend_commercial_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  late final _CommercialEndpoint commercial;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    commercial = _CommercialEndpoint(
      endpoints,
...
class _WaitlistEndpoint {
  ...
  _ida.Future<void> join(
    _ist.TestSessionBuilder sessionBuilder,
    _iiut8fxl.JoinWaitlistRequest request,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _ist.InternalTestSessionBuilder).internalBuild(
